...
const FlashCardForm:React.FC<IFlashCardForm> = ({control,idx,errors,watchFields,register,remove,card}) => {
			...
			<Grid item container spacing={2} alignItems="center" justify="center">
				...
				<Grid item xs={12} lg={4}>
					<div className="input-field">
						<DefinitionAutocomplete word={watchFields[0]} control={control} name ={`cards.${idx}.definition`} errors={errors} idx={idx} value={card.definition}/>
